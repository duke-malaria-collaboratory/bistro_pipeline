...
humans <- read_csv(snakemake@input[[2]], col_types = cols(.default = col_character())) %>% suppressMessages()
mozzies <- read_csv(snakemake@input[[3]], col_types = cols(.default = col_character())) %>% suppressMessages()
mozzie_ids_all <- read_csv(snakemake@input[[4]], col_types = cols(.default = col_character())) %>% pull(SampleName) %>% suppressMessages()
